...
class ApplicationForm(ctk.CTkFrame):
  def __init__(self, master):
    ...
    self.__combo_bday = DateSelector(master=self.__form_frame, label='Birthdate')
    self.__combo_bday.grid(row=2, column=0, pady=10, padx=10, sticky='we')
    ...
    self.__save = ctk.CTkButton(master=self.__form_frame, text='Save', font=('Calibri', 22), width=160, height=80)
