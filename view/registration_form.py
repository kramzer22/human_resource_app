...
class RegistrationForm(ctk.CTkFrame):
  def __init__(self, master, pady=0, padx=0):
    ...
    self._entry_user = TextInput(master=self, label_text='User name', input_require=True, font=(FORM_FONT_FAMILY, FORM_FONT_SIZE), fg_color='transparent')
    ...
    self._entry_email = TextInput(master=self, label_text='Email', input_require=True, font=(FORM_FONT_FAMILY, FORM_FONT_SIZE), fg_color='transparent')
    ...
    self._entry_mobile = TextInput(master=self, label_text='Mobile number', font=(FORM_FONT_FAMILY, FORM_FONT_SIZE), fg_color='transparent')
    ...
    self._entry_password = TextInput(master=self, label_text='Password', input_require=True, font=(FORM_FONT_FAMILY, FORM_FONT_SIZE), fg_color='transparent')
    ...
    self._entry_repassword = TextInput(master=self, label_text='Re password', input_require=True, font=(FORM_FONT_FAMILY, FORM_FONT_SIZE), fg_color='transparent')
    ...
    self._link_login = LinkedLabel(master=self, text="Already a member? Click here to login", font=(FORM_FONT_FAMILY, FORM_FONT_SIZE), anchor='e')
    ...
    self._save.grid(row=7, column=0, pady=10, padx=padx)
